...
#define XPAR_ADC_REG_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_ADC_REG_BASEADDR 0x41220000
#define XPAR_ADC_REG_HIGHADDR 0x4122ffff
#define XPAR_ADC_REG_INTERRUPT_PRESENT 0x0
#define XPAR_ADC_REG_IS_DUAL 0x0
#define XPAR_ADC_REG_GPIO_WIDTH 0x8

/* Canonical definitions for peripheral ADC_REG */
#define XPAR_XGPIO_0_BASEADDR 0x41220000
#define XPAR_XGPIO_0_HIGHADDR 0x4122ffff
...
/* Definitions for peripheral AMP_ENABLE_REG */
#define XPAR_AMP_ENABLE_REG_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AMP_ENABLE_REG_BASEADDR 0x41210000
#define XPAR_AMP_ENABLE_REG_HIGHADDR 0x4121ffff
#define XPAR_AMP_ENABLE_REG_INTERRUPT_PRESENT 0x0
#define XPAR_AMP_ENABLE_REG_IS_DUAL 0x1
#define XPAR_AMP_ENABLE_REG_GPIO_WIDTH 0x8

/* Canonical definitions for peripheral AMP_ENABLE_REG */
...
/* Definitions for peripheral PHASE_REG */
#define XPAR_PHASE_REG_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_PHASE_REG_BASEADDR 0x41200000
#define XPAR_PHASE_REG_HIGHADDR 0x4120ffff
#define XPAR_PHASE_REG_INTERRUPT_PRESENT 0x0
#define XPAR_PHASE_REG_IS_DUAL 0x1
#define XPAR_PHASE_REG_GPIO_WIDTH 0x20

/* Canonical definitions for peripheral PHASE_REG */
