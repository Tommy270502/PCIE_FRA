...
// Date        : Thu Mar 19 14:48:17 2026
// Host        : ThinkpadT14s running 64-bit Ubuntu 24.04.4 LTS
// Command     : write_verilog -force -mode synth_stub -rename_top system_bd_axi_smc_0 -prefix
//               system_bd_axi_smc_0_ system_bd_axi_smc_0_stub.v
...
(* CHECK_LICENSE_TYPE = "system_bd_axi_smc_0,bd_3c1f,{}" *) (* CORE_GENERATION_INFO = "system_bd_axi_smc_0,bd_3c1f,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "bd_3c1f,Vivado 2025.1" *) 
module system_bd_axi_smc_0(aclk, aresetn, S00_AXI_awid, S00_AXI_awaddr, 
...
/* synthesis syn_force_seq_prim="aclk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.aclk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 50000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN system_bd_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:M01_AXI:M02_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken" *) input aclk /* synthesis syn_isclock = 1 */;
