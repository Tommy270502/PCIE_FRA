...
HD_PWD='/home/thomas/Documents/git/PCIE_FRA/hardware/fra_zynq7015_pcie/fra_zynq7015_pcie.runs/system_bd_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_bd_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_bd_axi_smc_0.tcl
