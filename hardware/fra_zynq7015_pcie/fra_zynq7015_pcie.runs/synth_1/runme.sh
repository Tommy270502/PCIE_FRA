...
HD_PWD='C:/Users/Thomas/Documents/git/PCIE_FRA/hardware/fra_zynq7015_pcie/fra_zynq7015_pcie.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fra_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fra_top.tcl
